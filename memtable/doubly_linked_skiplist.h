...
//
// DoublyLinkedSkipList is derived from SkipList (skiplist.h), but it optimizes
...
// DoublyLinkedSkipList will not be destroyed while the read is in progress.
// Apart from that, reads progress without any internal locking or
// synchronization.
//
// Invariants:
//
// (1) Allocated nodes are never deleted until the DoublyLinkedSkipList is
// destroyed.  This is trivially guaranteed by the code since we never
// delete any skip list nodes.
//
// (2) The contents of a Node except for the next/prev pointers are
// immutable after the Node has been linked into the DoublyLinkedSkipList.
...
class DoublyLinkedSkipList {
 ...
 public:
  ...
  // Create a new DoublyLinkedSkipList object that will use "cmp" for comparing
  ...
  // skiplist object.
  explicit DoublyLinkedSkipList(Comparator cmp, Allocator* allocator,
  ...
  class Iterator {
   public:
    ...
    explicit Iterator(const DoublyLinkedSkipList* list);

    // Change the underlying skiplist used for this iterator
    // This enables us not changing the iterator without deallocating
    // an old one and then allocating a new one
    void SetList(const DoublyLinkedSkipList* list);
   ...
   private:
    const DoublyLinkedSkipList* list_;
    Node* node_;
 ...
 private:
  ...
  // No copying allowed
  DoublyLinkedSkipList(const DoublyLinkedSkipList&);
  DoublyLinkedSkipList& operator=(const DoublyLinkedSkipList&);
};

// Implementation details follow

template <class Comparator>
struct DoublyLinkedSkipList<Comparator>::Splice {
...
template <class Comparator>
struct DoublyLinkedSkipList<Comparator>::Node {
  ...
  const char* Key() const { return reinterpret_cast<const char*>(&next_[2]); }
...
template <class Comparator>
inline DoublyLinkedSkipList<Comparator>::Iterator::Iterator(
    const DoublyLinkedSkipList* list) {
  SetList(list);
}

template <class Comparator>
inline void DoublyLinkedSkipList<Comparator>::Iterator::SetList(
    const DoublyLinkedSkipList* list) {
  list_ = list;
  node_ = nullptr;
}
...
template <class Comparator>
inline bool DoublyLinkedSkipList<Comparator>::Iterator::Valid() const {
  return node_ != nullptr;
}

template <class Comparator>
inline const char* DoublyLinkedSkipList<Comparator>::Iterator::key() const {
  assert(Valid());
  return node_->Key();
}

template <class Comparator>
inline void DoublyLinkedSkipList<Comparator>::Iterator::Next() {
  assert(Valid());
  node_ = node_->Next(0);
}
...
template <class Comparator>
inline void DoublyLinkedSkipList<Comparator>::Iterator::Seek(const char* target) {
  node_ = list_->FindGreaterOrEqual(target);
}

template <class Comparator>
inline void DoublyLinkedSkipList<Comparator>::Iterator::SeekForPrev(
    const char* target) {
  Seek(target);
  if (!Valid()) {
    SeekToLast();
...
template <class Comparator>
inline void DoublyLinkedSkipList<Comparator>::Iterator::SeekToFirst() {
  node_ = list_->head_->Next(0);
}

template <class Comparator>
inline void DoublyLinkedSkipList<Comparator>::Iterator::SeekToLast() {
...
template <class Comparator>
int DoublyLinkedSkipList<Comparator>::RandomHeight() {
...
template <class Comparator>
bool DoublyLinkedSkipList<Comparator>::KeyIsAfterNode(const char* key,
                                                Node* n) const {
...
template <class Comparator>
bool DoublyLinkedSkipList<Comparator>::KeyIsAfterNode(const DecodedKey& key,
                                                Node* n) const {
  // nullptr n is considered infinite
  assert(n != head_);
  return (n != nullptr) && (compare_(n->Key(), key) < 0);
...
template <class Comparator>
typename DoublyLinkedSkipList<Comparator>::Node*
DoublyLinkedSkipList<Comparator>::FindGreaterOrEqual(const char* key) const {
...
template <class Comparator>
typename DoublyLinkedSkipList<Comparator>::Node*
DoublyLinkedSkipList<Comparator>::FindLessThan(const char* key, Node** prev) const {
  return FindLessThan(key, prev, head_, GetMaxHeight(), 0);
}

template <class Comparator>
typename DoublyLinkedSkipList<Comparator>::Node*
DoublyLinkedSkipList<Comparator>::FindLessThan(const char* key, Node** prev,
...
template <class Comparator>
typename DoublyLinkedSkipList<Comparator>::Node*
DoublyLinkedSkipList<Comparator>::FindLast() const {
  Node* x = head_;
  int level = GetMaxHeight() - 1;
  while (true) {
    Node* next = x->Next(level);
...
template <class Comparator>
uint64_t DoublyLinkedSkipList<Comparator>::EstimateCount(const char* key) const {
  uint64_t count = 0;
...
template <class Comparator>
DoublyLinkedSkipList<Comparator>::DoublyLinkedSkipList(const Comparator cmp,
                                           Allocator* allocator,
                                           int32_t max_height,
...
template <class Comparator>
char* DoublyLinkedSkipList<Comparator>::AllocateKey(size_t key_size) {
  return const_cast<char*>(AllocateNode(key_size, RandomHeight())->Key());
}

template <class Comparator>
typename DoublyLinkedSkipList<Comparator>::Node*
DoublyLinkedSkipList<Comparator>::AllocateNode(size_t key_size, int height) {
...
template <class Comparator>
typename DoublyLinkedSkipList<Comparator>::Splice*
DoublyLinkedSkipList<Comparator>::AllocateSplice() {
...
template <class Comparator>
bool DoublyLinkedSkipList<Comparator>::Insert(const char* key) {
  return Insert<false>(key, seq_splice_, false);
}

template <class Comparator>
bool DoublyLinkedSkipList<Comparator>::InsertConcurrently(const char* key) {
...
template <class Comparator>
bool DoublyLinkedSkipList<Comparator>::InsertWithHint(const char* key, void** hint) {
  assert(hint != nullptr);
...
template <class Comparator>
template <bool prefetch_before>
void DoublyLinkedSkipList<Comparator>::FindSpliceForLevel(const DecodedKey& key,
...
template <class Comparator>
void DoublyLinkedSkipList<Comparator>::RecomputeSpliceLevels(const DecodedKey& key,
                                                       Splice* splice,
                                                       int recompute_level) {
...
template <class Comparator>
template <bool UseCAS>
bool DoublyLinkedSkipList<Comparator>::Insert(const char* key, Splice* splice,
...
template <class Comparator>
bool DoublyLinkedSkipList<Comparator>::Contains(const char* key) const {
...
template <class Comparator>
void DoublyLinkedSkipList<Comparator>::TEST_Validate() const {
