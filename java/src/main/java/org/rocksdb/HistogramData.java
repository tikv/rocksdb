...
public class HistogramData {
  ...
  public HistogramData(final double median, final double percentile95,
                       final double percentile99, final double percentile999,
                       final double average, final double standardDeviation) {
    this(median, percentile95, percentile99, percentile999, average, standardDeviation, 0.0, 0, 0, 0.0);
  }

  public HistogramData(final double median, final double percentile95,
      final double percentile99, final double percentile999, final double average,
