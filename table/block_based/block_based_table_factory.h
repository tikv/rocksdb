    ...
    block_based_table_type_info = {
        ...
        {"block_align",
         {offsetof(struct BlockBasedTableOptions, block_align),
          OptionType::kBoolean, OptionVerificationType::kNormal, false, 0}},
        {"refill_block_cache_level",
         {offsetof(struct BlockBasedTableOptions, refill_block_cache_level),
          OptionType::kInt32T, OptionVerificationType::kNormal, false, 0}},
        {"refill_filter_and_index_level",
         {offsetof(struct BlockBasedTableOptions, refill_filter_and_index_level),
          OptionType::kInt32T, OptionVerificationType::kNormal, false, 0}},
