...
extern ROCKSDB_LIBRARY_API void rocksdb_options_set_report_bg_io_stats(
    rocksdb_options_t*, int);
extern ROCKSDB_LIBRARY_API char* rocksdb_options_statistics_get_histogram_string(
        rocksdb_options_t* opt, uint32_t type);
extern ROCKSDB_LIBRARY_API unsigned char rocksdb_options_statistics_get_histogram(
        rocksdb_options_t* opt,
        uint32_t type,
        double* median,
        double* percentile95,
